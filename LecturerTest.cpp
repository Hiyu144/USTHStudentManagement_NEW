...
int main() {
	//Test constructor
	Lecturer Son(1, "Cao Thanh Son", "08/04/94", "Modor", "Computer Science", "PhD", 20);
	//Test print
	Son.Print();
	//Test Set
	//Son.Set_name("Thu Huyen");
//	Son.Set_enter_year(1999);
//	Son.Set_class_name("203");
//	Son.Set_major("Bio");
//	Son.Print();
//	
//	//Test Get
...
//	int tempEnterYear = Son.Get_enter_year()+1;
